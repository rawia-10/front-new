...
class LoginS extends Component {
  ...
  login = () => {
    ...
    // }
    //  else {
      axios.post('http://127.0.0.1:8813/secretaire/login', {
          ...
          <div className="containere">
            <div className="signin-content">
              <div className="signin-image">
                ...
                <a href="#" className="signup-image-link">   </a>
              </div>
              ...
              }
               {
                ...
                this.state.erreur===true ?
                  ...
                  {/*   <input onClick={this.login} type="submit" name="signin" id="signin" className="form-submit" value="Login" defaultValue="Log in" />*/}
                    <input type="submit" onClick={this.login} name="signin" id="signin" className="form-submit" defaultValue="Log in" /> 
                  </div> 
                ...
                {/*   <div className="form-group form-button">
                  ...
                  <span className="d-flex align-item-center justify-content-center p-2 notreg ">Créer un compte</span>
